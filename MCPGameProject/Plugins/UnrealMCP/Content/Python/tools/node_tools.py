...
def register_blueprint_node_tools(mcp: FastMCP):
    ...
    def add_blueprint_event_node(
        ...
        unreal.log(f"Adding event node '{event_name}' to blueprint '{blueprint_name}'")
        response = GameThreadRunner.run_cpp_command("add_blueprint_event_node", params)
        return response or {}
    ...
    def add_blueprint_input_action_node(
        ...
        response = GameThreadRunner.run_cpp_command(
            "add_blueprint_input_action_node", params
        )
        return response or {}
    ...
    def connect_blueprint_nodes(
        ...
        unreal.log(f"Connecting nodes in blueprint '{blueprint_name}'")
        response = GameThreadRunner.run_cpp_command("connect_blueprint_nodes", params)
        return response or {}
    ...
    def add_blueprint_variable(
        ...
        unreal.log(f"Adding variable '{variable_name}' to blueprint '{blueprint_name}'")
        response = GameThreadRunner.run_cpp_command("add_blueprint_variable", params)
        return response or {}
    ...
    def create_input_mapping(
        ...
        unreal.log(f"Creating input mapping '{action_name}' with key '{key}'")
        response = GameThreadRunner.run_cpp_command("create_input_mapping", params)
        return response or {}
    ...
    def add_blueprint_self_reference(
        ...
        unreal.log(f"Adding self reference node to blueprint '{blueprint_name}'")
        response = GameThreadRunner.run_cpp_command(
            "add_blueprint_self_reference", params
        )
        return response or {}
